...
\begin{summary}
    ...
    \begin{itemize}
        ...
        As $E-V$ increases, the frequency of ocillation increases and the amplitude decreases.
...
\begin{summary}
    ...
    There is also a differentiabilty boundary condition that is uncovered by integrating either side of the Schrödinger equation over an infinitesimal neighborhood around the potential spike.
